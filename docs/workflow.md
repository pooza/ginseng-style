...
| 🔴 **指摘なし** | **PR 本体への 👍 だけ**（`issues/N/reactions` の bot の `+1`）。⚠⚠ **review でもコメントでもない** |
...
- 🔴 **待機ループの終了条件も 4 経路の OR にする。** ⚠⚠ **「無いの測り方」を知っていても、終了条件に写さなければ意味が無い** — 1 巡目が review で来ると、待ち方までその形に引っ張られる
